...
def test_properties(z1r: GeneralizedHiddenMarkovModel):
...
def test_single_transition(z1r: GeneralizedHiddenMarkovModel):
...
def test_generate(z1r: GeneralizedHiddenMarkovModel):
    batch_size = 4
    sequence_len = 10
...
def test_probability(z1r: GeneralizedHiddenMarkovModel):
...
def test_log_probability(z1r: GeneralizedHiddenMarkovModel):
    observations = jnp.array([1, 0, 0, 1, 1, 0])
    expected_probability = 1 / 12
