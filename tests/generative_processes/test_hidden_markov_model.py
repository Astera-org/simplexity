...
def test_properties(z1r: HiddenMarkovModel):
    ...
    assert_proportional(z1r.stationary_state, jnp.ones(3))
...
def test_generate(z1r: HiddenMarkovModel):
    ...
    intermediate_states, intermediate_observations = z1r.generate(
    ...
    final_states, final_observations = z1r.generate(intermediate_states, keys, sequence_len, DO_NOT_RETURN_ALL_STATES)
