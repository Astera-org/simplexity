...
def test_log_space_operations_are_not_in_the_core_contract() -> None:
    ...
    assert isinstance(MinimalProcess(), GenerativeProcessProtocol)
...
def test_omitting_any_log_space_member_breaks_the_extension_only(member: str) -> None:
    ...
    assert isinstance(partial_process, GenerativeProcessProtocol)
    assert not isinstance(partial_process, LogSpaceGenerativeProcessProtocol)
...
def test_log_space_protocol_requires_the_core_members_too() -> None:
    ...
    assert not isinstance(log_space_only, LogSpaceGenerativeProcessProtocol)
...
def test_core_process_does_not_satisfy_the_log_space_protocol() -> None:
    ...
    assert not isinstance(MinimalProcess(), LogSpaceGenerativeProcessProtocol)
...
def test_log_space_process_satisfies_both_protocols() -> None:
    ...
    assert isinstance(process, LogSpaceGenerativeProcessProtocol)
...
def test_omitting_any_core_member_breaks_conformance(member: str) -> None:
    ...
    assert not isinstance(partial_process, GenerativeProcessProtocol)
