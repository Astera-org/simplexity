...
def test_is_model_persister_target_valid():
...
def test_is_model_persister_target_invalid():
...
def test_is_persister_config_valid():
...
def test_is_persister_config_invalid():
...
def test_validate_persistence_config_valid():
...
def test_validate_persistence_config_missing_instance():
...
def test_validate_persistence_config_invalid_instance():
...
def test_validate_persistence_config_non_persister_target():
    ...
    with pytest.raises(ConfigValidationError, match="PersistenceConfig.instance._target_ must be a persister target"):
        validate_persistence_config(cfg)
...
def test_validate_persistence_config_invalid_name():
...
def test_validate_hooked_transformer_config_config_valid():
...
def test_validate_hooked_transformer_config_config_invalid_fields(field):
...
def test_validate_hooked_transformer_config_config_d_model_not_divisible_by_n_heads():
...
def test_validate_hooked_transformer_config_config_d_head_times_n_heads_not_equal_d_model():
...
def test_validate_hooked_transformer_config_valid():
...
def test_validate_hooked_transformer_config_missing_target():
...
def test_validate_hooked_transformer_config_missing_cfg():
...
def test_is_predictive_model_target_valid():
...
def test_is_predictive_model_target_invalid():
...
def test_is_model_config_valid():
...
def test_is_model_config_invalid():
...
def test_validate_model_config_missing_instance():
...
def test_validate_model_config_invalid_instance():
...
def test_validate_model_config_non_model_target():
    """Test validate_model_config raises when instance target is not a model target."""
    cfg = DictConfig({"instance": DictConfig({"_target_": "simplexity.logging.mlflow_logger.MLFlowLogger"})})
    with pytest.raises(ConfigValidationError, match="ModelConfig.instance._target_ must be a predictive model target"):
        validate_model_config(cfg)
...
def test_validate_model_config_invalid_load_checkpoint_step():
...
def test_is_optimizer_target_valid():
...
def test_is_optimizer_target_invalid():
...
def test_is_optimizer_config_valid():
...
def test_is_optimizer_config_invalid():
...
def test_is_pytorch_optimizer_config_valid():
...
def test_is_pytorch_optimizer_config_invalid():
...
def test_validate_optimizer_config_valid():
...
def test_validate_optimizer_config_missing_instance():
...
def test_validate_optimizer_config_invalid_instance():
...
def test_validate_optimizer_config_non_optimizer_target():
    """Test validate_optimizer_config raises when instance target is not an optimizer target."""
    cfg = DictConfig({"instance": DictConfig({"_target_": "simplexity.logging.mlflow_logger.MLFlowLogger"})})
    with pytest.raises(ConfigValidationError, match="OptimizerConfig.instance._target_ must be an optimizer target"):
        validate_optimizer_config(cfg)
...
def test_validate_optimizer_config_invalid_name():
...
def test_validate_training_config_valid():
...
def test_validate_training_config_invalid_fields(field):
...
def test_validate_training_config_field_greater_than_num_steps(field):
...
def test_validate_training_config_missing_optimizer():
...
def test_validate_training_config_invalid_optimizer():
